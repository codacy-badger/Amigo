...
const errors = require("../util/Logger.js"); //Required for error logging
let PMIfWrong=true // If the user doesn't give heads or tails as an argument whether to private message them telling them this or send a message to the channel the command was in telling them it isnt a valid input. If this is set to true it will private message the user, if it is set to false it will send a message to the channel.By default this is set to true
...
module.exports.run = async (bot, message, args) => {
    ...
    let HeadsOrTails=possibilities[Math.floor(Math.random()*possibilities.length)]
